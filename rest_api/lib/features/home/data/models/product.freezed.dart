...
class _$ProductModelImpl implements _ProductModel {
  ...
  @override
  String toString() {
    return 'ProductModel(id: $id, title: $title, price: $price, description: $description, category: $category, image: $image, productRatingModel: $productRatingModel)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, price, description,
      category, image, productRatingModel);
